defmodule Mix.Tasks.Swagger.Gen.Json do
  ...
  Generates controller, views, and context for a JSON resource.
      ...
      mix swagger.gen.json Accounts User users name:string age:integer
  ...
  with their respective names and types. See `mix swagger.gen.schema`
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix swagger.gen.json Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix swagger.gen.json Sales User users --web Sales
  ...
  use binary ids for primary keys, see `mix swagger.gen.schema` for more
  information.
  """
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix swagger.gen.json must be invoked from within your *_web application root directory"
      )
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Phoenix.copy_from(paths, "priv/templates/swagger.gen.json", binding, files)
